...
<div class="page-content">
	...
	<div class="portlet box blue">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-reorder"></i>SAIFI / CAIDI
			</div>
			<div class="tools">
	...
	<div class="portlet-body ">
		...
		<div class="row" style="margin-left: -1px;">
			...
			<div class="col-md-3" id="">
						<div class="form-group">
							...
							<div class="input-group date">
								<input type="text" class="form-control from" 
									name="month_year" id="month_year" placeholder="YYYYMM" style="width: 100%;"></input>
									<span class="input-group-btn">
							<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
							</span>
							</div> <!-- <input
								type="text" id="manufacturingMonthYear"
								class="form-control placeholder-no-fix"
								placeholder="Enter Manufacturing  Month-Year"
								name="manufacturingMonthYear" maxlength="12"></input> -->
						</div>
					</div>
					...
					<div class="col-md-3">	
					<div class="form-group">
						<button type="button" onclick="return viewSaidiReport();"  
				 class="btn blue" style="margin-top: 19px;">View
			</button>
			</div>
			</div>
			...
			<div class="btn-group pull-right">
				...
				<ul class="dropdown-menu pull-right">
					...
					<li><a href="#" id="exportExcel"
						onclick="generateServiceExcel('sample_1','SAIDI/CAIDI Report');">Export
							to Excel</a></li>
				</ul>
			</div>
			<table class="table  table-bordered table-hover" id="sample_1">
				...
				<thead>
					<tr>
						...
						<th>Sl No</th>
						<th>Feeder/DT/Boundary Name</th>
						<th>Feeder/DT/Boundary Code</th>
						<th>Total Consumers</th>
						<th>Total Interruptions</th>
						<th>Interruptions >10min</th>
						<th>Total Momentary Interruptions</th>
						<th>Outage Durations >10min</th>
						<th>Total Outage Durations</th>
						<th>SAIFI</th>
						<th>SAIDI</th>
						<th>CAIDI</th>
						<th>CAIFI</th>
...
$('.from2').datepicker({
	...
	minViewMode : "years",
	autoclose : true,
	startDate : new Date(year+1, month + 1, '31'),
