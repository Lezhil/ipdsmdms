...
function showResultsbasedOntownCode(town){
	...
	function viewArea() {
	    ...
	    var date1 = new Date(frommonth);
	    var date2 = new Date(frommonth);
...
<div class="page-content">
	<div class="portlet box blue">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-reorder"></i>SAIFI / SAIDI
			</div>
			<div class="tools">
		...
		<div class="portlet-body">
			...
			<div class="modal-body">
				...
				<div class="row">
						...
						<Strong>Select Report Type</Strong>
							<select class="form-control select2me" 
								name="townfeeder" id="townfeeder" onchange="showFeederDiv(this.value);">
									...
									<option value="feeder">Feeder Wise</option>
					...
					<div class="col-md-3" id="monthlyDiv" hidden="true">
					...
					<div class="col-md-3" id="feederDiv" hidden="true">
						<div  class="form-group">
							<Strong>Select Feeder <font color="red">*</font></Strong> <select
					...
					<div class="col-md-3">
						...
						<button type="button" id="jsonData" onclick="downloadReport()"
							style="margin-top: 25px;" name="jsonData" class="btn green">
							<b>Export to JSON</b>
						</button>
					</div>
				</div>
				...
				<div class="form-group col-md-3">
					...
					<div class="col-md-3" id="feederDiv" hidden="true">
						<div  class="form-group">
							<label>Select Feeder <font color="red">*</font></label> <select
								class="form-control select2me" id="feeder"
								name="feeder">
								<option value="">Select Feeder</option>
							</select>
				...
				<!-- <div class="row">
					<div class="col-md-3">
						<button type="button" id="viewAreaId" style="margin-left: 0px;"
							name="viewAreaId" class="btn green" onclick="viewArea()">
							<b>View</b>
						</button>
						
						<button type="button" id="jsonData" onclick="downloadReport()"
							style="margin-left: 0px;" name="jsonData" class="btn green">
							<b>Export to JSON</b>
						</button>
					</div>
				...
				<div class="table-toolbar">
					<div class="btn-group pull-right" style="margin-top: 15px;">
							...
							<ul class="dropdown-menu pull-right">
								...
								<li><a href="#" id=""
							onclick="exportPDF('sample_3','ReliabilityIndicesFeeder')">Export to PDF</a></li>
...
function downloadReport() {
	...
	window.open("./exportjsonSaifiSaidiFeeder?frommonth=" + frommonth + "&townfeeder=" + townfeeder + "&town=" + town + "&feeder=" + feeder+"&tomonth="+tomonth);
...
<script>
	...
	var frommonth=$('#FromMonthId1').val();
	   var tomonth=$('#ToMonthId1').val();
		...
		//alert("hii town"+town)
		//alert("hii townfeeder"+townfeeder)
		var zne="",cir="",twn="";
		if(zoneNew == "%")
	{
		zne = "ALL";
	...
	//alert("hii town1"+twn)
		...
		window.location.href= ("./ReliabilityIndicesFeederSummary?frommonth="+ frommonth +"&twn="+twn+"&zne="+zne+"&cir="+cir+"&tomonth="+tomonth+ "&feeder="+feeder+"&townname1="+townname1+"&feedername="+feedername+"&townfeeder="+townfeeder+"&tomonth="+tomonth);					
	}
