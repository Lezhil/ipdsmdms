...
<script  type="text/javascript">
	$(".page-content").ready(function(){  
		 ...
		 $("#selectedDateId").val('${month}');
				...
				$('#MDMSideBarContents,#MIS-Reports,#dateWiseMissingBillDataId').addClass('start active ,selected');
...
<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-globe"></i>DateWise Missing Meters In Bill Data</div>
							<div class="tools">
						...
						<div class="portlet-body">
								<form method="post" id="meterMissingId" action="">
										<table>
										<tr>
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-globe"></i>Result List : <span id="dateId" style="color:yellow">${month}</span></div>
		...
		function validation()
		{
		 ...
		 $("#meterMissingId").attr("action","./missingMetrsListResult").submit();
