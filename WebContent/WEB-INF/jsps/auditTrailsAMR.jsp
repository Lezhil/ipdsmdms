...
<script  type="text/javascript">
	$(".page-content").ready(function(){  
		...
		TableManaged.init();
		FormComponents.init();			
		 $('#MDMSideBarContents,#auditTrailsAMR,#dataValidId').addClass('start active ,selected');
	...
	<div class="row">
		<div class="col-md-12">
			<div class="portlet-body">
							...
							<div class="caption"><i class="fa fa-edit"></i>Data Validations:
								...
								<td><div class="col-md-3">
										<div
											...
											<input type="text" placeholder="From Date"
												...
												data-date="${currentDate}"  autocomplete="off"
												data-date-format="yyyy-mm-dd" data-date-end-date="0d" data-date-viewmode="years" name="fromDate" id="fromDate">
											<span class="input-group-addon">to</span> <input type="text"
												placeholder="To Date" class="form-control"
												value="<fmt:formatDate value="${currentDate}" pattern="yyyy-mm-dd" />"
												data-date="${currentDate}"  autocomplete="off"
												data-date-format="yyyy-mm-dd" data-date-end-date="0d" data-date-viewmode="years" name="toDate" id="toDate">
										</div>
									</div></td>

								<td><button type="submit" id="dataview" class="btn yellow"
										formaction="./getAuditTrailDataAMR" formmethod="post">
										<b>View</b>
									</button></td>
