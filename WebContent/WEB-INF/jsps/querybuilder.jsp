 ...
 <script  type="text/javascript">
	$(".page-content").ready(function(){  
		...
		//loadSearchAndFilter('dataPopTable');
		 ...
		 $('#ADMINSideBarContents,#querybuilder').addClass('start active ,selected');
		...
		<div class="col-md-12">
			<div class="portlet box blue" >
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-edit"></i>QUERY BUILDER
					</div>
					<div class="tools">
				...
				<div class="portlet-body">
						<div class="row" style="margin-left: 2%">
							<div class="form-group col-md-3">
							    <label >Schema</label>
							   	<select class="form-control select2me" name="schema" id="schemaName" onchange="getTableName(this.value)" >
						 	   <option value="">Select</option>
								<c:forEach items="${schemalist}" var="element">
							    ...
							    <label >Data Objects</label>
					   		   <select class="form-control select2me " name="tableName" id="tableName" onchange="getColumnName(this.value);">
						 	   <option value="">Select</option>
						 	   </select>
						 	   </div>
					   		<!-- <div class="form-group col-md-3">
							    <label >Aggregate Functions</label>
					   		   <select class="form-control select2me " name="aggregateFunc" id="aggregateFunc" onchange="selectedfunctions(this.value);">
						 	   <option value="">Select</option>
					   		...
					   		<div class="form-group col-md-3">
							    <label >Column Names</label>
					   		   <select class="form-control select2me" name="columnName" id="columnName" multiple="multiple" onchange="selectedColunm(this.value);">
						 	   <option value="">Select</option>
						 	   </select>
						 	   </div>
					   		</div>
					   		...
					   		<div class="form-group col-md-3" >
							    <label>Filter</label>
					   		   <select class="form-control select2me " name="filter" id="filter" onchange="setCondition(this.value);">
						 	   <option value="">Select</option>
						 	   </select>
						 	 </div>
							...
							<div >
									<button class="btn btn-primary " value="="  onClick="setOPerator(this.value)">=</button>
									<button class="btn btn-primary " value=">" onClick="setOPerator(this.value)" >></button>
									<button class="btn btn-primary " value="<" onClick="setOPerator(this.value)" ><</button>
									<button class="btn btn-primary " value=">=" onClick="setOPerator(this.value)" >>=</button>
									<button class="btn btn-primary " value="<=" onClick="setOPerator(this.value)" ><=</button>
									<button class="btn btn-primary " value="<>" onClick="setOPerator(this.value)" ><></button>
									<button class="btn btn-primary " value="AND" onClick="setOPerator(this.value)" >AND</button>
									<button class="btn btn-primary " value="OR" onClick="setOPerator(this.value)" >OR</button>
									<button class="btn btn-primary " value="NOT" onClick="setOPerator(this.value)" >NOT</button>
									<button class="btn btn-primary " value="LIKE" onClick="setOPerator(this.value)" >LIKE</button>
									<button class="btn btn-primary " value="IS" onClick="setOPerator(this.value)" >IS</button>
									<button class="btn btn-primary " value="IN" onClick="setOPerator(this.value)" >IN</button>
									<button class="btn btn-primary " value="NULL" onClick="setOPerator(this.value)" >NULL</button>
                                </div>
						 	 </div>
					</div>
					 <div class="row" style="margin-left: 2%">
					 <div class="form-group col-md-3">
							    <label><span>Group By Statements</span></label>
					   		   <select class="form-control select2me " name="groupbyStatements" id="groupbyStatements" onchange="setGroupBySTatement(this.value);">
						 	   <option value="">Select</option>
					   		...
					   		<div class="form-group col-md-3 col-md-offset-1">
							    <label>Group By ColumnNames</label>
					   		   <select class="form-control select2me " name="groupbyAttribute" id="groupbyAttribute" onchange="setGroupByColunm(this.value);">
						 	   <option value="">Select</option>
						 	   </select>
						 	 </div>
						 	 ...
						 	 <!--  Viw Report -->
						 	  ...
						 	  <div class="form-group col-md-3">
							    <label><span>View All Reports</span></label>
					   		   <select class="form-control select2me " name="groupbyStatements" id="groupbyStatements" onchange="viewReportDetails(this.value)">
						 	   <option value="">Select</option>
						 	   
						<c:forEach items="${list}" var="table_names">
						<option value='${table_names.report_name}'>${table_names.report_name}</option>
						</c:forEach>
						 	   </select>
						 	   </div>
