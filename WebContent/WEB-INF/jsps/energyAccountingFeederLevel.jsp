 	 ...
 	 $('.datepicker').datepicker({
	        ...
	        $('.datepicker').keyup(function () {
	            if (this.value.match(/[^0-9]/g)) {
	   	   	...
	   	   	$('#MDMSideBarContents,#eaId,#energyAccountingFeederLevel,#feederWiseEAreport').addClass('start active ,selected');
		...
		<div class="page-content" >
		    <div class="portlet box blue "  id="boxid">
			    <div class="portlet-title">
					<div class="caption"><i class="fa fa-reorder"></i>Feeder EA Report</div>
					<div class="tools">
					...
					<tr>
						...
						<th id="fromDateMonthly">
						 ...
						 <!-- <th id="fromDatePeriodic">
										<div class="input-group input-medium date date-picker "  data-date-format="yyyy-mm-dd" data-date-viewmode="years" id="fromDate">
																...
																<th class="block" id= "todatelabel">To&nbsp;BillMonth&nbsp;:</th><th>
				...
				<tr>
					...
					<%-- 	<th class="block" id='circlelabel'>Sub-Division&nbsp;:</th>
						...
						<!-- <th class="block" id=subStation >Sub-Station&nbsp;:</th>
							<th id="subStation"><select
								class="form-control select2me input-medium" id="subStationList"
								name="subStation">
						...
						<!-- 	<tr><th colspan="8"></th></tr><tr><th colspan="8"></th></tr>
							<tr>
								...
								<th id="subdivTd">
									<select
										class="form-control select2me input-medium" id="feeder"
										name="feeder">
									</select>
							   </th>
									...
									<div id="excelExportDiv2">
										...
										<ul class="dropdown-menu pull-right">
												...
												<li><a href="#" id="excelExport2" 
													onclick="tableToExcel2('sample_3', 'Energy Accounting Feeder Report')">Export
									 				to Excel</a></li>
										</ul>
...
function view(){
	...
	$.ajax({
		url:"./getEneryAccoutingDataFeederWise",
		type:"get",
		data:{
			fromdate:fromdate,
			todate:todate,
