	...
	<div class="page-content">
			...
			<div class="row">
				...
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-edit"></i>DT LoadDataAvailability Report
					</div>
					...
					<div class="table-toolbar">
							...
							<div class="btn-group pull-right" style="margin-top: 3px;">
								...
								<ul class="dropdown-menu pull-right">
									...
									<li><a href="#" id="excelExport" onclick="tableToXlxs('sample_2', 'Load Data Availability Report');">Export to Excel</a></li>
								 	...
								 	<table class="table table-striped table-bordered table-hover" id="sample_2">
											...
											<thead>
													...
													<tr>
														...
														<th colspan='7' style="text-align:center;">Load Data Availability Report</th>
