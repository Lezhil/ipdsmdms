...
<script  type="text/javascript">
	...
	$(".page-content").ready(function(){			
		...
		$('#MDMSideBarContents,#metermang,#datamodification').addClass('start active ,selected');
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-globe"></i>Data Modification</div>
							<div class="tools">
						...
						<div class="portlet-body">
									...
									<form:form action="./updateAMRConnectionData"  class="form-inline" role="form" modelAttribute="newConnectionMeterMaster" commandName="newConnectionMeterMaster" method="post" id="dataModificationId" >		  
													<table>
													
													<tr><td>
													<label>RdngMonth<form:input path="rdngmonth"  id="rdngmonth" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="" value="201806" ></form:input></label>
													</td><td>
													<label>AccNo<form:input path="accno"  id="accno" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Enter ACCNO" maxlength="13" name="accno" onchange="return onEnter(this.value);"></form:input></label>
														</td>
													<td>
