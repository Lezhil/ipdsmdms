	...
	$(".page-content")
			.ready(
					...
					function() {
						...
						App.init();
						$('#MDMSideBarContents,#dataValidId,#validationReport')
...
<script>
 function exportGridData(table,name)
{
...
function tableToPdf()
{
	...
	window.location.href = "./downloadValidationExceptionPdf?z="+z+"&c="+c+"&t="+t+"&ruleId="+ruleId+"&month="+month;
	}
	...
	function estimateData(meterNumber, fromDate, toDate, ruleId) {
		...
		//alert(meter_number+fromDate+toDate+ruleId);
      //  $("#view_rule").show();
      
       $('#estrule').find('option').remove();
		...
		$.ajax({
			...
			success : function(response) {
				if(response.length !=0 || response==null ){
				 ...
				 /*  var html='';
					html += "<select id='estrule' name='estrule' class='form-control' type='text'><option value=''>Estimation Rule</option>";
				for( var i=0;i<response.length;i++)
				{
					html+="<option  value='"+response[0][0]+"'>"+response[0][1]+"</option>";
				}
	...
	function processData(){
		...
		var tourl="";
		 if(!"EST01".localeCompare(gEstRuleId)){
			 tourl='./processAvgIpData';
		 }
		 else if(!"EST02".localeCompare(gEstRuleId)){
		...
		<div class="col-md-12">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-edit"></i>Data Validation Reports
					</div>
					<div class="tools">
										...
										<ul class="dropdown-menu pull-right">
											<li><a href="#" id="excelExport"
												onclick="tableToExcel('sample_1', 'ValidatioReport')">Export
													to Excel</a></li>
													<li><a href="#" id="excelExport"
												onclick="tableToPdf('sample_1', 'ValidatioReport')">Export
													to PDF</a></li>
										</ul>
									</div>
								</div>
						...
						<div class="table-toolbar">
								<div class="btn-group pull-right" >
									...
									<ul class="dropdown-menu pull-right">
										...
										<li>
										<a href="#" id="pdfexport" onclick="exportGridData('sample_2', 'RTCfailureReports')">Export to PDF</a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="table-toolbar">
								<div class="btn-group pull-right" >
									...
									<ul class="dropdown-menu pull-right">
										...
										<li>
										<a href="#" id="pdfexport" onclick="exportGridData('sample_3', 'MissingLoadDataReports')">Export to PDF</a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="table-toolbar">
								<div class="btn-group pull-right" >
									...
									<ul class="dropdown-menu pull-right">
										...
										<li>
										<a href="#" id="pdfexport" onclick="exportGridData('sample_4', 'IncompleteLoadDataReports')">Export to Pdf</a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="table-toolbar">
								<div class="btn-group pull-right" >
									...
									<ul class="dropdown-menu pull-right">
										...
										<li>
										<a href="#" id="pdfexport" onclick="exportGridData('sample_5', 'MissingEventReports')">Export to Pdf</a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="table-toolbar">
								<div class="btn-group pull-right" >
									...
									<ul class="dropdown-menu pull-right">
										...
										<li>
										<a href="#" id="pdfexport" onclick="exportGridData('sample_7', 'InvalidPowerFactorReports')">Export to Pdf</a>
										</li>
						...
						<div class="table-toolbar">
								<div class="btn-group pull-right" >
									...
									<ul class="dropdown-menu pull-right">
										...
										<li>
										<a href="#" id="pdfexport" onclick="exportGridData('sample_8', 'LessKVAReports')">Export to Pdf</a>
										</li>
						...
						<div class="table-toolbar">
								<div class="btn-group pull-right" >
									...
									<ul class="dropdown-menu pull-right">
										...
										<li>
										<a href="#" id="pdfexport" onclick="exportGridData('sample_9', 'ThresoldFreqReports')">Export to Pdf</a>
										</li>
									</ul>
								</div>
						</div>
				...
				<div class="modal-body">
						...
						<tbody>
							<tr>
								...
								<th id="estRuleTd"><select
									class="form-control select2me input-medium" id="estrule"
									name="estrule">
					...
					<div class="modal-footer">
						<button class="btn green pull-right" type="button"
							  data-toggle='modal' data-target='#stack4' onclick="processData()">Estimate</button>
		...
		<div class="modal-dialog">
			...
			<h4 class="modal-title">Estimated Data</h4>
				...
				<div class="modal-body">
					...
					<div class="modal-footer">
						<button class="btn green pull-right" type="button"
							data-dismiss="modal" onclick="saveData()">Save</button>
						<button class="btn red pull-left" type="button"
							data-dismiss="modal" onclick="formreset()">Cancel</button>
					</div>
				</div>
