...
@Entity
@Table(name = "pfc_d3_rpt_intermediate", schema="meter_data",uniqueConstraints={@UniqueConstraint(columnNames = { "month_year","town_code" })})
public class PfcD3ReportIntermediateEntity {

	@EmbeddedId  // FOR MAKING UNIQUE KEY
	private pfcd3IntermediateKey myKey; // month_year , towncode
	...
	public pfcd3IntermediateKey getMyKey() {
		return myKey;
	}

	public void setMyKey(pfcd3IntermediateKey myKey) {
		this.myKey = myKey;
	}
	...
	@Embeddable
	public static class pfcd3IntermediateKey  implements Serializable {
		...
		public pfcd3IntermediateKey(String month_year, String town_code) {
			super();
			this.month_year = month_year;
			this.town_code = town_code;
		}

		public pfcd3IntermediateKey() {
