...
@Table(name = "npp_feeder_rpt_intermediate",  schema = "METER_DATA",uniqueConstraints = { @UniqueConstraint(columnNames = { "tp_fdr_id","study_month","study_year","flag" }) })
...
public class NppFeederReportIntermediate {
	
	@EmbeddedId  // FOR MAKING UNIQUE KEY
	private KeyNppIntermediate keyNppIntermediate;
...
@Embeddable
public static  class KeyNppIntermediate implements Serializable {
	...
	public KeyNppIntermediate(String tp_fdr_id, Integer study_month,
	...
	public KeyNppIntermediate() {
		
	}
}


public KeyNppIntermediate getKeyNppIntermediate() {
	return keyNppIntermediate;
}


public void setKeyNppIntermediate(KeyNppIntermediate keyNppIntermediate) {
	this.keyNppIntermediate = keyNppIntermediate;
}
