...
@Entity
//@Table(name="npp_feeder_rpt_intermediate_copy0711",schema="meter_data")
@Table(name = "npp_dt_rpt_intermediate",  schema = "METER_DATA",uniqueConstraints = { @UniqueConstraint(columnNames = { "tpdtid","study_month","study_year","flag" }) })
//@Table(name = "npp_feeder_rpt_intermediate_copy0711",  schema = "METER_DATA",uniqueConstraints = { @UniqueConstraint(columnNames = { "tp_fdr_id","study_month","study_year","flag" }) })

public class NppDtReportIntermediate {
	
	@EmbeddedId  // FOR MAKING UNIQUE KEY
	private KeyNppDtIntermediate keyNppDtIntermediate;
	...
	private Long hut_consumer_count;
...
@Embeddable
public static  class KeyNppDtIntermediate implements Serializable {
	...
	public Integer getStudy_month() {
		return study_month;
	}

	public void setStudy_month(Integer study_month) {
		this.study_month = study_month;
	}
	...
	public KeyNppDtIntermediate(String tpdtid, Integer study_month,
			Integer study_year, String flag) {
		super();
		this.tpdtid = tpdtid;
		this.study_month = study_month;
		this.study_year = study_year;
...
public Long getHut_consumer_count() {
	return hut_consumer_count;
}


public void setHut_consumer_count(Long hut_consumer_count) {
	this.hut_consumer_count = hut_consumer_count;
}
...
public KeyNppDtIntermediate getKeyNppDtIntermediate() {
	return keyNppDtIntermediate;
}


public void setKeyNppDtIntermediate(KeyNppDtIntermediate keyNppDtIntermediate) {
	this.keyNppDtIntermediate = keyNppDtIntermediate;
}
