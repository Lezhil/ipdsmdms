...
@Controller
public class EnergyAccountingDataRefereshController {

	@Autowired
	NppDTrptMonthlyCalculationService nppDTrptMonthlyCalculationService;
	
	
	@RequestMapping (value = "/monthluComsumptionAutoPush", method = { RequestMethod.GET, RequestMethod.POST})
	  @ResponseBody  public String monthluComsumptionAutoPush(HttpServletRequest request){
		
		
		String monthYear = request.getParameter("billmonth");
			...
			try {
				result = nppDTrptMonthlyCalculationService.getMonthlyConsumptionDetails(monthYear);
				msg = "success";
	...
	@RequestMapping(value = "/dailyComsumptionAutoPush", method = { RequestMethod.GET, RequestMethod.POST })
	 @ResponseBody public String  dailyComsumptionAutoPush(HttpServletRequest request) {
		...
		try {
			...
			result = nppDTrptMonthlyCalculationService.getDailyConsumptionDetails(monthYear,fromDate,todate);
		msg = "success";
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	@RequestMapping(value = "/billComsumptionAutoPush", method = { RequestMethod.GET, RequestMethod.POST })
	 @ResponseBody public String  billComsumptionAutoPush(HttpServletRequest request) {
		...
		try {
			...
			result = nppDTrptMonthlyCalculationService.getBillConsumptionDetails(monthYear,fromDate,todate);
		msg = "success";
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	@RequestMapping(value = "/moninpComsumptionAutoPush", method = { RequestMethod.GET, RequestMethod.POST })
	 @ResponseBody public String  moninpComsumptionAutoPush(HttpServletRequest request) {
		...
		try {
			...
			result = nppDTrptMonthlyCalculationService.getMonthinpConsumptionDetails(monthYear);
		msg = "success";
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	@RequestMapping(value = "/instComsumptionAutoPush", method = { RequestMethod.GET, RequestMethod.POST })
	 @ResponseBody public String  instComsumptionAutoPush(HttpServletRequest request) {
		...
		try {
			...
			result = nppDTrptMonthlyCalculationService.getinstComsumptionAutoPush(monthYear,fromDate,todate);
		msg = "success";
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	@RequestMapping(value = "/missingvoltageAutoPush", method = { RequestMethod.GET, RequestMethod.POST })
	 @ResponseBody public String  missingvoltageAutoPush(HttpServletRequest request) {
		...
		try {
			...
			result = nppDTrptMonthlyCalculationService.getmissingvoltageAutoPush(monthYear,fromDate,todate);
		msg = "success";
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	@RequestMapping(value = "/missingvoltageAutoPush_vy", method = { RequestMethod.GET, RequestMethod.POST })
	 @ResponseBody public String  missingvoltageAutoPush_vy(HttpServletRequest request) {
		...
		try {
			...
			result = nppDTrptMonthlyCalculationService.getmissingvoltageAutoPush_vy(monthYear,fromDate,todate);
		msg = "success";
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	@RequestMapping(value = "/missingvoltageAutoPush_vb", method = { RequestMethod.GET, RequestMethod.POST })
	 @ResponseBody public String  missingvoltageAutoPush_vb(HttpServletRequest request) {
		...
		try {
			...
			result = nppDTrptMonthlyCalculationService.getmissingvoltageAutoPush_vb(monthYear,fromDate,todate);
		msg = "success";
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	@RequestMapping (value = "/afterMonthlyCOnsumtionDTEADataPush", method = { RequestMethod.GET, RequestMethod.POST})
	  @ResponseBody  public String afterMonthlyCOnsumtionDTEADataPush(HttpServletRequest request){
		...
		String monthYear = request.getParameter("billmonth");
			...
			try {
				result = nppDTrptMonthlyCalculationService.getAfterMonthlyCOnsumtionDTEADataPush(monthYear);
				msg = "success";
	...
	@RequestMapping (value = "/energyAccountingDTDataPush", method = { RequestMethod.GET, RequestMethod.POST})
	  @ResponseBody  public String energyAccountingDTDataPush(HttpServletRequest request){
		...
		String monthYear = request.getParameter("billmonth");
			...
			try {
				result = nppDTrptMonthlyCalculationService.energyAccountingDTDataPush(monthYear);
				msg = "success";
	...
	@RequestMapping (value = "/afterMonthlyCOnsumtionFeederTownEADataPush", method = { RequestMethod.GET, RequestMethod.POST})
	  @ResponseBody  public String afterMonthlyCOnsumtionFeederTownEADataPush(HttpServletRequest request){
		...
		String monthYear = request.getParameter("billmonth");
			...
			try {
				result = nppDTrptMonthlyCalculationService.getafterMonthlyCOnsumtionFeederTownEADataPush(monthYear);
				msg = "success";
	...
	@RequestMapping (value = "/afterMonthlyCOnsumtionFeederTownEADataPushForFeeder", method = { RequestMethod.GET, RequestMethod.POST})
	  @ResponseBody  public String afterMonthlyCOnsumtionFeederTownEADataPushForFeeder(HttpServletRequest request){
		...
		String monthYear = request.getParameter("billmonth");
			...
			try {
				result = nppDTrptMonthlyCalculationService.getAfterMonthlyCOnsumtionFeederTownEADataPushForFeeder(monthYear);
				msg = "success";
	...
	@RequestMapping (value = "/afterMonthlyCOnsumtionFeederTownEADataPushForBoundaryr", method = { RequestMethod.GET, RequestMethod.POST})
	  @ResponseBody  public String afterMonthlyCOnsumtionFeederTownEADataPushForBoundaryr(HttpServletRequest request){
		...
		String monthYear = request.getParameter("billmonth");
			...
			try {
				result = nppDTrptMonthlyCalculationService.getAfterMonthlyCOnsumtionFeederTownEADataPushForBoundaryr(monthYear);
				msg = "success";
	  ...
	  @RequestMapping (value = "/dataRefreshNppInterToDTmonthly/{rptMonth}", method = { RequestMethod.GET, RequestMethod.POST})
	  @ResponseBody  public String dataSyncforD1report(@PathVariable String rptMonth){
		  //@RequestParam String billmonth
		String monthYear = rptMonth;
	
			List<Object[]> result  = null;
			String msg = null;
			try {
				result = nppDTrptMonthlyCalculationService.getNppIntermediateDtData(monthYear);
			...
			NppDTrptMonthlyCalculation nppDtMonthly = new NppDTrptMonthlyCalculation();
			System.out.println("########" +item[0].toString());
		
					
					try {
						nppDTrptMonthlyCalculationService.save(nppDtMonthly);	
					} catch (Exception e) {
	  ...
	  @RequestMapping (value = "/dataPushMainFeeder/{rptMonth}/{towncode}", method = { RequestMethod.GET, RequestMethod.POST})
	  @ResponseBody  public String dataPushMainFeeder(@PathVariable String rptMonth,@PathVariable String towncode){ 
	  ...
	  for (int i = 12; i >= 0 ; i -= 2) {
			 ...
			 String qry = "insert into meter_data."+TableName+" (\n" +
			  ...
			  " Select kwh_imp ,mc.kwh_exp, mtrno,billmonth,fd.boundry_feeder  from  meter_data.monthly_consumption mc  \n" +
	  ...
	  */
	  ...
	  try {
	x =   nppDTrptMonthlyCalculationService.getCustomEntityManager("postgresMdas").createNativeQuery(qry).getResultList();
	} catch (Exception e) {
		e.printStackTrace();
	}
	  ...
	  @RequestMapping (value = "/dataPushBoundaryFeeder/{rptMonth}/{towncode}", method = { RequestMethod.GET, RequestMethod.POST})
	  @ResponseBody  public String dataPushBoundaryFeeder(@PathVariable String rptMonth,@PathVariable String towncode){ 
	...
	x =   nppDTrptMonthlyCalculationService.getCustomEntityManager("postgresMdas").createNativeQuery(qry).getResultList();
	  ...
	  @RequestMapping (value = "/dataPushDT/{rptMonth}/{towncode}", method = { RequestMethod.GET, RequestMethod.POST})
	  @ResponseBody  public String dataPushBoundaryDT(@PathVariable String rptMonth,@PathVariable String towncode){ 
	  ...
	  String qry = "insert into meter_data."+TableName+"(\n" +
			  ...
			  "FROM \n" +
			  "(select distinct on (tpdtid)tpdtid as tpdtid,tp_fdr_id,towncode, meterno, meterno1,dtname,feedername,officeid, COALESCE(meterno2,'0') AS METERNO2, \n" +
			  ...
			  " \n" +
			  " \n" +
			  "from meter_data.npp_dt_rpt_monthly_calculation npDt where meterno is not null and meterno <>''   GROUP BY tp_fdr_id,tpdtid,towncode,dtname,feedername,officeid, METERNO)x\n" +
			  "left join \n" +
